              ...
              {isApproved ? (
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 mb-1">
                        Show this to officers for attendance verification
                      </p>
                      ...
                      <div className="bg-white rounded-lg p-6 flex flex-col items-center">
                        <div className="w-64 h-64 bg-gray-100 rounded-lg flex items-center justify-center mb-4">
                          ...
                          <div className="text-center">
                            <QrCode
                              size={200}
                              className="text-[#2C5530] mx-auto mb-2"
                            />
                ...
                <div className="flex flex-col items-center justify-center py-8">
                  ...
                  <p className="text-gray-600 text-center max-w-md mb-4">
                    Your registration is currently pending approval by an
                    administrator. Your QR code will be generated once your
                    account is approved.
                  </p>
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 max-w-md">
                    <p className="text-sm text-yellow-800">
                      <strong>Note:</strong> You will receive an email
                      notification once your account has been approved. After
                      approval, you'll be able to access your QR code for event
                      attendance.
                    </p>
                  </div>
                </div>
