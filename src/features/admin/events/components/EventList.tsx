...
import {
  ...
  updateEvent,
  deleteEvent,
} from '@/features/admin/events/services/EventService';
import EventDialog from './EventDialog';
import AttendanceDialog from '@/features/admin/attendances/components/AttendanceDialog';
import type {
  Attendance,
  AttendanceFormData,
} from '@/features/admin/attendances/attendance.type';
import attendanceService from '@/features/admin/attendances/services/AttendanceService';
